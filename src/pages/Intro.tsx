...
export const Intro = () => {
  ...
  return (
    <div
      className="bg-[#F2F5FD] flex absolute justify-center"
      style={{ top: "0", bottom: "0", left: "0", right: "0" }}
    >
      <Logo />
      <div className="absolute flex mt-4" style={{ right: "1%" }}>
        <div
          className="p-1 border-[#A974FF] border-2 rounded-[10px] cursor-pointer"
          onClick={moveToSignIn}
        >
          Sign In
        </div>
        <div
          className="p-1 border-[#A974FF] border-2 ml-2 rounded-[10px] bg-[#A974FF] cursor-pointer"
